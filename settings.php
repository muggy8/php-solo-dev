<?php
	...
	// (unimplemented yet) if this is true, any page that is visited by a user will also output the page_name.html and save it in the same directory as the file itself. eg: if the file exists at {htRoot}/index.php it will output a file at {htRoot}/index.html with whatever responce it gets. 
